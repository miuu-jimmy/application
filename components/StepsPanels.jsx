...
export default function StepsPanels({ steps }) {
            ...
            <li key={step.id} className="relative overflow-hidden lg:flex-1">
              ...
              >
                {step.status === 'complete' ? (
                  <a href={step.href} onClick={(e) => handleClick(step.href, e)} className="group">
                    <span
                  ...
                  <a href={step.href} onClick={(e) => handleClick(step.href, e)} aria-current="step">
                    <span
