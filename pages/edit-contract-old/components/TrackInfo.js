              ...
              <div className="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div>
                  ...
                  <div className="mt-1 flex flex-col gap-y-2">
                    ...
                    <button
                      type="button"
                      className="bg-white py-2 px-3 w-16 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    >
                      Add
                    </button>
                  </div>
