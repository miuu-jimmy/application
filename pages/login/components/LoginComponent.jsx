...
import { redirectAction} from "../../../store/redusers/authReducer";
...
const LoginComponent = (props) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (error) {
            ...
            snackbar.showMessage("An Error Occured. Contact our support for help ","error","filled")
        } else {
            snackbar.showMessage("You are logged in. Redirecting.... ","success","filled")
